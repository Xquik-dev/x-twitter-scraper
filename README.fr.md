...
la plateforme est facturée à part. Excluez les diagnostics avec `resultType !== "diagnostic"`.
...
Connectez-vous à LobeHub. Installez et vérifiez les Skills :
...
Vérifiez le dépôt. Installez et vérifiez ensuite les Skills :
