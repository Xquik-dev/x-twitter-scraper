...
投稿、プロフィール、タイムライン、フォロワー、返信、引用、反応したユーザー、
メディア、リスト、コミュニティ、記事、地域トレンドに対応します。

### リアルタイム監視に対応していますか？

Xquik は対応するアカウントとキーワードを継続監視します。イベントは API または
署名付き webhook で受け取れます。遅延ゼロの配信を保証するものではありません。
...
プライバシー、著作権、契約のルールに従う必要があります。目的、アクセス、保存期間、
削除方法を記録してください。高リスクの用途では法律の専門家に相談してください。
