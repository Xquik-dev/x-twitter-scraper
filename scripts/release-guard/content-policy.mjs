...
export const contentChecks = [
  {
    ...
    required: [
      ...
      "The package `x-developer` contains this Skill and plugin bundle. The separate `x-twitter-scraper` package is the TypeScript SDK.",
    ...
    forbidden: [
      ...
      "@latest",
      "bunx skills add Xquik-dev/x-twitter-scraper",
  ...
  },
  {
    ...
    required: [
      ...
      "X (Twitter) Scraper API and X API Alternative",
  ...
  },
  {
    ...
    required: [
      ...
      "Binary support downloads remain REST-only.",
  ...
  },
  {
    ...
    required: ["usage estimate", "Wait for explicit user confirmation."],
