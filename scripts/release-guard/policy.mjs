...
/** Each entry maps a repository path to a version extractor. */
...
export const skillFrontmatterExpectations = {
  scalars: {
    ...
    "metadata.security.credentialsHandledByAgent": "rest-api-key-only",
    "metadata.security.credentialsTransmitted": "rest-x-api-key-or-mcp-bearer-fallback",
  ...
  arrays: {
    ...
    "metadata.capabilities.environment.required": [],
    "metadata.capabilities.environment.optional": [
      "XQUIK_API_KEY",
