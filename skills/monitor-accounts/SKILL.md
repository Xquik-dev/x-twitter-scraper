...
description: "Use when the user wants to monitor one or more X (Twitter) accounts for new tweets, replies, or profile changes. Creates long-running monitors, polls events, and can fire webhooks on match. Continuous monitoring workflow."
license: MIT
metadata:
  author: Xquik
  version: "1.0.0"
...
| GET /events?monitor_id=<id>&since=<cursor> | Poll new events | Read tier |
