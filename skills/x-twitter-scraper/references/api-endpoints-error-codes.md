...
and `code`. The current OpenAPI schema enumerates all 112 codes. This table
...
| 410 | `closed` | Top-up billing session is closed |
| 410 | `expired` | Top-up billing session is expired |
...
| 502 | `missing_url` | Payment page lookup failed |
