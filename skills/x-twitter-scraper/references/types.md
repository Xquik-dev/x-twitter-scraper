...
Routing index for TypeScript response and request shapes. Load only the type section needed for the user task.
...
| Bookmarks & Timeline | [bookmarks-and-timeline.md](types-bookmarks-and-timeline.md) |
